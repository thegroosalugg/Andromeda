...
const Banner: React.FC<BannerProps> = ({ reverse, children }: BannerProps) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true, amount: 0.01 }} // temporarily set amount to 1% in view in conjuction with RootLayout to stop 1st banner being in view during page transition
    >
      <motion.span
